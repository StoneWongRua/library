...
public class LibrarianLogin extends JFrame {
	...
	public LibrarianLogin() {
		...
		JLabel lblAdminLoginForm = new JLabel("图书管理员登录");
		lblAdminLoginForm.setForeground(Color.black);
		lblAdminLoginForm.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(LibrarianDao.validate(name, password)){
				...
				JOptionPane.showMessageDialog(LibrarianLogin.this, "用户名或密码出错!","登录失败!", JOptionPane.ERROR_MESSAGE);
				textField.setText("");
