...
import com.tong.dao.BooksBorrow;
...
public class StudentLoginSuccess extends JFrame {
	static StudentLoginSuccess frame;
	...
	public StudentLoginSuccess() {
		...
		JLabel lblLibrarianSection = new JLabel("Student Login");
		lblLibrarianSection.setFont(new Font("Tahoma", Font.PLAIN, 22));
		
		JButton btnNewButton = new JButton("Borrow Books");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			BooksBorrow.main(new String[]{});
			frame.dispose();
			}
		});
