...
import com.tong.dao.IssueBookDao;
...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() {
		...
		btnIssueBook.addActionListener(new ActionListener() {
			...
			if(IssueBookDao.checkBook(callno)){
			
			int i=IssueBookDao.save(callno, studentid, studentname, studentcontact);
			if(i>0){
				try {
				...
				JOptionPane.showMessageDialog(IssueBookForm.this,"Sorry, Locate doesn't exist!");
