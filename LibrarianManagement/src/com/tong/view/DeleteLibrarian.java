...
public class DeleteLibrarian extends JFrame {
	...
	public DeleteLibrarian() {
		...
		JLabel lblEnterId = new JLabel("ÊäÈë±àºÅ:");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteLibrarian.this,"²»ÄÜÊäÈë¿ÕID");
				}else{
					int id=Integer.parseInt(sid);
					int i=LibrarianDao.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"³É¹¦É¾³ý!");
					}else{
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"ÎÞ·¨É¾³ý¸ÃID");
					}
				}
			}
		});
		btnDelete.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 13));
		...
		btnNewButton.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 13));
